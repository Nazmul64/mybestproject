...
/* whilsit product added start */


/*end whilist prouddct*/
/*cukstom check color start */
...
/*end custom check in database end*/
...
/*End Hotdeal product slider */
/*start product detials size */
document.querySelectorAll('.color-option').forEach(item => {
    item.addEventListener('click', () => {
        item.classList.toggle('active');
    });
});
/*end product details size */
// custom javascript  category slider
...
$(document).ready(function(){
    $('.category-slider').slick({
        ...
        slidesToScroll: 1,
        autoplay: true,
        autoplaySpeed: 3000,  // Changed autoplay speed to 3000ms (3 seconds)
        arrows: true,
        dots: false,
        responsive: [
            {
...
// end custom  category slider javascrip
